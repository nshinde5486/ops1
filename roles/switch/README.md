...
[![Build Status](https://travis-ci.org/open-switch/ops-ansible.svg)](https://travis-ci.org/open-switch/ops-ansible)

## Overview

OpenSwitch `switch` provides the foundation to configure the layer 2 and 3
reachability, e.g. VLANs, IPv4, and/or IPv6 addresses, on the switch.
